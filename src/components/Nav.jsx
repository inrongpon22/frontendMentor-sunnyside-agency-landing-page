  ...
  return (
    <main className='flex md:flex-row lg:flex-row justify-between px-[4rem] py-[3rem] text-white'>
        ...
        <div className={clicked ? 'showHamMenu' : 'hideHamMenu'}>
          <ul className="absolute md:static flex flex-col items-center bg-white md:bg-transparent text-[#818498] md:text-white font-semibold py-5 px-5 md:flex-row">
          ...
          <div className='z-10 translate-x-[12.95rem] -translate-y-[0.9rem] w-0 h-0 
